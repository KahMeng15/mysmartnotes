...
async def set_cache_async(key: str, value: Any, ttl: int = None):
...
def set_cache_sync(key: str, value: Any, ttl: int = None):
...
def cache_response(ttl: int = None, user_specific: bool = True):
    """
    ...
    def decorator(func: Callable):
        ...
        async def wrapper(*args, **kwargs):
            ...
            # Base key from URL
            cache_key = f"cache_resp:{request.url.path}:{str(request.query_params)}"
