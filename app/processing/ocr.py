...
class OCRProcessor:
    ...
    @staticmethod
    def extract_from_pdf(file_path: str, resource_id: str = "0", structured: bool = True, use_v2: bool = True) -> Tuple[str, List[ContentSegment], List]:
        """
    ...
    @staticmethod
    def extract_from_pptx(file_path: str, resource_id: str = "0", structured: bool = True, use_v2: bool = True) -> Tuple[str, List[ContentSegment], List]:
        """
    ...
    @staticmethod
    def extract_text(file_path: str, file_type: str, note_id: str = "0", use_v2: bool = True) -> Dict[str, Any]:
        """
