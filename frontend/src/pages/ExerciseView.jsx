...
import { IconArrowLeft, IconCheck, IconX, IconBulb, IconBook, IconDownload, IconFileTypePdf, IconFileTypeDocx, IconEdit, IconTrash, IconPlus, IconClock, IconDeviceFloppy } from '@tabler/icons-react';
    ...
    <Box>
      ...
      <Grid>
          ...
          <Stack spacing="xl">
            {editMode ? (
              <Box>
                ...
                <Button mt="md" fullWidth color="blue" loading={savingEdits} onClick={handleSaveEdits} leftSection={<IconDeviceFloppy size={16} />}>
                  Save Changes
                </Button>
              </Box>
            ) : (
        ...
        <Grid.Col span={{ base: 12, md: 4 }}>
          <Card withBorder shadow="sm" radius="md" p="md" pos="sticky" top={20}>
            <Title order={4} mb="md">Exercise Controls</Title>
            ...
            <Text size="xs" c="dimmed" ta="center">
              Generated by MySmartNotes AI<br/>Questions are saved as JSON
            </Text>
          </Card>
        </Grid.Col>
      </Grid>
